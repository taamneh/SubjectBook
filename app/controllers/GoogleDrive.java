...
public class GoogleDrive {
    ...
    private final static String CLIENT_ID = "244043910780-hfaucr1q34i87t28ofj2lu70jgm6ho3p.apps.googleusercontent.com";
    private final static String CLIENT_SECRET = "ejv6Y0N7up7XUmKENhXMLsXt";
    ...
    public static org.json.simple.JSONObject DownloadSignal(String username, String url, int sourceType, int signalType, int frameRate,int first_row, int first_col, String activityFile, String baseLineFile, String baselineSessionName, TreeMap<String, String> desc)  throws  Exception
    {
                ...
                if (signalType == 4) { //TODO: use constant name
                    ...
                    if (activityFile != null) {
                        ...
                        if(baseLineFile != null) {
                            ...
                            x = ReadExcelJava.fromExcelInputTemp(frameRate, ReadExcelJava.getAllSignalFromExcelAbstraction(fileName2, 1), baselineSessionName, ReadExcelJava.readActivity(downloadFileByFileId(service, activityFile)), fileName, first_row, first_col);
                            input2.close();
                        }
                        else
                            x = ReadExcelJava.fromExcelInputTemp(frameRate,null, baselineSessionName, ReadExcelJava.readActivity(downloadFileByFileId(service, activityFile)), fileName, first_row, first_col);
                    } else {
