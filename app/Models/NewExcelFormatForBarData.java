...
public class NewExcelFormatForBarData {

    public JsonFromExcel dataFromExcel;  // polymorphism

    public NewExcelFormatForBarData(JsonFromExcel data){
        dataFromExcel = data;
    }
    ...
    private  class SheetHandler extends DefaultHandler {
        ...
        public void endElement(String uri, String localName, String name)
            ...
            //////////////////////////////// Code to support bar charts //////////////////////
            if(dataFromExcel instanceof BarChartFromExcel){

                if (nextIsString) {
                    int idx = Integer.parseInt(lastContents);
                    lastContents = new XSSFRichTextString(sst.getEntryAt(idx)).toString();
                    nextIsString = false;
                    if (rowNumber == 9)  // to avoid the title of the sheet at row 8 and frame at first col
        ...
        /////////////////////////////////////////////////////////////For Bar support/////////////
        private void addToContentForBar (){

            if(tempRowNum == rowNumber) {
                dataFromExcel.addToContent(lastContents, false); // we still in the same line
            }
            else {
                dataFromExcel.addToContent(lastContents, true);
                tempRowNum = rowNumber;  // new line
            }
        }
        ///////////////////////////////////////////////////////////////////////////////////////
