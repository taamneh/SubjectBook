...
CREATE TABLE session (
    ...
    signal_signal_type int    NOT NULL
);

-- Table: `signal`
CREATE TABLE signals (
    signal_type int    NOT NULL ,
    singal_desc varchar(100)    NOT NULL ,
    CONSTRAINT signal_pk PRIMARY KEY (signal_type)
);
...
CREATE TABLE study (
    ...
    portrait_string varchar(10000) NULL,
...
ALTER TABLE session ADD CONSTRAINT session_signal FOREIGN KEY (signal_signal_type)
    REFERENCES signals (signal_type);
-- Reference:  session_subject (table: session)
